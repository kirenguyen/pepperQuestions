...
Write to text file... 'directory$'/'soundname$'.syllables.TextGrid
...
# 'soundname$', 'voicedcount', 'npause', 'originaldur:2', 'speakingtot:2', 'speakingrate:2', 'articulationrate:2', 'asd:3'
